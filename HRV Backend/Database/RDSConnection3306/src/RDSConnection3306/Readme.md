...
WORKDIR /src
COPY ["RDSConnection3306.csproj", "RDSConnection3306/"]
RUN dotnet restore "RDSConnection3306/RDSConnection3306.csproj"

WORKDIR "/src/RDSConnection3306"
COPY . .
RUN dotnet build "RDSConnection3306.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "RDSConnection3306.csproj" \
...
Execute unit tests
```
cd "RDSConnection3306/test/RDSConnection3306.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "RDSConnection3306/src/RDSConnection3306"
